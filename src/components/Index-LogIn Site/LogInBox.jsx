...
const LogInBox = () => {
    ...
    const choosingRandomCode = () => { //Fn losuje kod z tablicy
    ...
    const checkForm = () => {
        if (inputLogin.current.value === "" || inputPassword.current.value === "" || inputCode.current.value === "") {
    ...
    return (
        <div className="LogInBox">
            <label>
                Wpisz login:
                <input type="text" className="login" placeholder="Login" ref={inputLogin} />
                <p className="error-login error" style={isHidden}>Podano zły login</p>
            </label>

            <label>
                Wpisz hasło:
                <input type="password" placeholder="Hasło" className="password" ref={inputPassword} />
                <p className="error-password error" style={isHidden}>Podano złe hasło</p>
            </label>
            <p className="code">{randomCode}</p>
            <p>Przepisz powyższy kod:</p>
            <input type="text" ref={inputCode} />
            <p className="error-code error" style={isHidden}>Podano zły kod</p>
